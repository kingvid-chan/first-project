define({ "api": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "demo",
        "content": "<div class=\"j-module\" module-function=\"baseSlide\" demo=\"{imgArea:\".jbannerImg\", imgNode:\".jbannerImg dl\", tabArea:\".jbannerTab\", tabNode:\".jbannerTab span\", photoName:\".jDesc\", arrowLeft:\".jPreOut\", arrowRight:\".jNextOut\", arrowLeftOver:\"jPreOver\", arrowRightOver:\"jNextOver\", defaultClass:\"show\", message:\".jMessageRemind\", pageMode:\".j-edit-page\"}\">;\n也可以不传使用默认参数：<div class=\"j-module\" module-function=\"baseSlide\" demo=\"{}\">;",
        "type": "json"
      },
      {
        "title": "code",
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "demo",
        "content": "<div class=\"j-module\" module-function=\"base\" demo=\"{countDownInfo:'$!countDownInfo',hasDay:false,minuteCnt:'.minutes',secondCnt:'.seconds',minsecCnt:'.minsec', hasMinSec: true}\" >\n    <div class=\"jTime\">\n        <span class=\"jText\">距离活动结束还有:</span>\n        <span class=\"jNum\">\n            <em class=\"minutes\">00</em><i>分</i><em class=\"seconds\">00</em><i>秒</i><em class=\"minsec\">00</em>\n        </span>\n    </div>\n</div>",
        "type": "json"
      },
      {
        "title": "code",
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "demo",
        "content": "\n<div class=\"j-module\" module-function=\"addFavorite\" demo=\"{}\">  \n   click ME！！！\n</div>",
        "type": "json"
      },
      {
        "title": "code",
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "demo",
        "content": "<div class=\"j-module\" module-function=\"sideSlip\" demo=\"{horizontalValue:100,zindex:999}\">  \n    <ul>   \n        <li>\n            aaaa\n        </li>   \n        <li>\n            aaaa\n        </li>   \n        <li>\n            aaaa\n        </li>   \n        <li>\n            aaaa\n        </li>   \n        <li>\n            aaaa\n        </li>   \n        <li>\n            aaaa\n        </li>  \n    </ul>\n</div>",
        "type": "json"
      },
      {
        "title": "code",
  ...
  },
  {
    ...
    "description": "<p>商品名称截断处理，自动添加省略号--注意：demo不能为空，且字符串被截断出来的短字符串必须含有标点符号，否则报错</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
    ...
    "examples": [
      {
        "title": "demo",
        "content": "<div class=\"j-module\" module-function=\"addEllipsis\" demo=\"{text:'....'}\">  \n    <ul>   \n        <li>\n            aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\n        </li>   \n        <li>\n            aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\n        </li>   \n        <li>\n            aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\n        </li>   \n        <li>\n            aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\n        </li>   \n        <li>\n            aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\n        </li>  \n    </ul>\n</div>",
        "type": "json"
      },
      {
        "title": "code",
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "demo",
        "content": "<div class=\"j-module\" module-function=\"choiceLot\" demo=\"{rid:'$redirctId', containerSelector: '.j-list-wrap', itemTempSelector: '.j-template-li'}\">\n    <script type=\"template\" class=\"j-template-li\">\n        <li {{clstag}}>\n            <div>商品id：{{goodsId}}</div>\n            <div>商品名称：{{wname}}</div>\n            <div>跳转链接：{{url}}</div>\n            <div>图片url：{{imageurl}}</div>\n            <div>商品别名：{{alias}}</div>\n            <div>楼层id：{{groupId}}</div>\n            <div>标签：{{label}}</div>\n        </li>\n    </script>\n    <ul class=\"j-list-wrap\"></ul>\n</div>",
        "type": "json"
      },
      {
        "title": "demo",
